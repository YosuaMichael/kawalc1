# Test code to extract the partai from sample images

import cv2
import numpy as np


ref = cv2.imread("ref/dpr_plano_pkb.png")
code = "plano_gerindra"
img = cv2.imread("sample/dpr_{}.jpg".format(code))
...
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.imwrite("sample/partai_{}.png".format(code), extracted)
